export const en = {
  ...
  sneakersSection: {
    ...
    headerSubTitle:
      "Shop for new releases from must-have names like Air Jordan, Nike, New Balance and Yeezy, along with the latest collaborations from brands like Vans, Reebok, Converse, ASICS, and more.",
    filterSneakers: {
      filterTitle: "Filter",
      model: "Model",
      sizes: "Sizes",
    ...
    to: "to",
    filterErrors: {
      yearBiggerLower: "'From' year should be lower than 'To' year",
      yearBigger: "Year can't be bigger than 2023",
      yearLower: "Year can't be lower than 1994",
      priceBiggerLower: "'From' price should be lower than 'To' price",
      priceBigger: "Price can't be bigger than 6000",
      priceLower: "Price can't be lower than 10",
    },
    sneakersResult: {
      ...
      emptyText: {
        ...
        checkFilters: "Please check your filters or search for another sneaker",
      },
    },
  },
  ...
  favoriteSection: {
    ...
    emptyFavorites: "You haven't added favorite sneakers yet",
  },
  ...
  sneakerPage: {
    ...
    buy: "Buy for",
    goToCart: "Go to cart",
    addedToCart: "Item is added to cart",
    delivery: {
  ...
  admin: {
    ...
    orders: "Orders (all customers)",
    unitsSold: "Units sold",
    revenueByMonth: "Revenue by month",
    revenue: "Revenue",
    topProducts: "Top products by revenue",
    chartNoData: "No sales data yet",
    allRecentOrders: "Recent orders (all customers)",
